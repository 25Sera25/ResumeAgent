    ...
    <>
      ...
      <aside className={cn(
            ...
            <div>
              ...
              <div className="space-y-1 relative">
                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    <div key={step.id} className="relative flex items-start space-x-3 py-2">
                      {/* Progress Ring / Number */}
                      <div className={cn(
                        "relative flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold z-10 transition-all duration-300",
        ...
        <div className="p-6 border-t border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900">
          <h4 className="text-xs font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wide mb-3">
            Session Stats
          </h4>
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm text-neutral-600 dark:text-neutral-400">Jobs Analyzed</span>
              <span className="text-sm font-bold text-neutral-800 dark:text-neutral-100 bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5 rounded-md" data-testid="stat-jobs-analyzed">
                {stats.jobsAnalyzed}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-neutral-600 dark:text-neutral-400">Resumes Generated</span>
              <span className="text-sm font-bold text-neutral-800 dark:text-neutral-100 bg-purple-100 dark:bg-purple-900/30 px-2 py-0.5 rounded-md" data-testid="stat-resumes-generated">
                {stats.resumesGenerated}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-neutral-600 dark:text-neutral-400">Applications Sent</span>
              <span className="text-sm font-bold text-neutral-800 dark:text-neutral-100 bg-green-100 dark:bg-green-900/30 px-2 py-0.5 rounded-md" data-testid="stat-applications-sent">
                {stats.applicationsSent}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-neutral-600 dark:text-neutral-400">Follow-ups Scheduled</span>
              <span className="text-sm font-bold text-neutral-800 dark:text-neutral-100 bg-amber-100 dark:bg-amber-900/30 px-2 py-0.5 rounded-md" data-testid="stat-followups-scheduled">
      ...
      <Button
        ...
        size="sm"
        className={cn(
          "lg:hidden fixed top-4 left-4 z-30 h-10 w-10 p-0 transition-all",
